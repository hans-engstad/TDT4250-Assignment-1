 ...
 * @generated
 */
public class Assign1FactoryImpl extends EFactoryImpl implements Assign1Factory {
	/**
	 ...
	 * @generated
	 */
	public static Assign1Factory init() {
		try {
			Assign1Factory theAssign1Factory = (Assign1Factory) EPackage.Registry.INSTANCE
					.getEFactory(Assign1Package.eNS_URI);
			if (theAssign1Factory != null) {
				return theAssign1Factory;
			}
		} catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new Assign1FactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		...
		case Assign1Package.STUDY_PLAN_SEMESTER:
			return createStudyPlanSemester();
		default:
	 ...
	 */
	@Override
	public ElectiveCoursesGroup createElectiveCoursesGroup() {
		ElectiveCoursesGroupImpl electiveCoursesGroup = new ElectiveCoursesGroupImpl();
		return electiveCoursesGroup;
	}
	 ...
	 */
	@Override
	public Assign1Package getAssign1Package() {
		return (Assign1Package) getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Assign1Package getPackage() {
